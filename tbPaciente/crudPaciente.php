<?php
  ...
  class CrudPac{
    ...
    function retornarNome($id){
        $sql="select Nome from tbPaciente where IdPaciente=".$id ;
        $query=mysqli_query($this->con, $sql);
        return $query;
    }
    function listaPorId(){
      $sql="select * from tbPaciente where IdPaciente=".$_REQUEST["id"] ;
      $query=mysqli_query($this->con, $sql);
      return $query;
    }
    ...
    function excluir(){
      $sql="delete from tbPaciente where IdPaciente=".$_REQUEST["id"];
    ...
    function alterar(){
      $sql="update tbPaciente set Email='".$_POST["Email"]."',DataNascimento='".$_POST["DataNascimento"]."', Cidade='".$_POST["Cidade"]."', Bairro='".$_POST["Bairro"]."', Nome='".$_POST["Nome"]."', CPF='".$_POST["CPF"]."', RG='".$_POST["RG"]."', Numero='".$_POST["Numero"]."', Observacoes='".$_POST["Observacoes"]."', Rua='".$_POST["Rua"]."' where IdPaciente ='".$_POST["id"]."'";        
      mysqli_query($this->con, $sql) or die (mysqli_error($this->con));
      header("Location:relatorioGeralPaciente.php");   
    }
  }
